...
```
cd existing_repo
git remote add origin https://gitlab.bucknell.edu/gar018/csci205_labs.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.bucknell.edu/gar018/csci205_labs/-/settings/integrations)
